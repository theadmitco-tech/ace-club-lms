...
9. [Recommended Reading Bug and Revised Contract](recommended-reading-revision.md) — approved section-wise V2 behavior for all next-class pre-reads and all previous-class Session materials inside their distinct time windows; Recommended practice remains unchanged.
