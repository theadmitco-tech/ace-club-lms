...
export default async function MocksPage() {
  ...
  return <div className="student-page"><StudentHeader studentName={result.participantName} testerMode={testerMode} />
    <main className="student-main"><div className="student-container mock-library">
      <header className="student-intro"><div><span className="student-eyebrow">Timed assessments</span><h1>Your mocks</h1><p>{testerMode ? 'Use assignment-scoped tester access to verify this mock before its batch release.' : 'Start a released sectional mock or choose the section order for a full mock, and continue from any saved attempt.'}</p></div></header>
